...
using SharpCommerce.Data;
using SharpCommerce.Core;
using System.IO;
using Microsoft.Extensions.FileProviders;
using Microsoft.AspNetCore.Http;
using SharpCommerce.Core.Contracts;
using System.Reflection;
using Microsoft.AspNetCore.Mvc.Razor;
using SharpCommerce.Extensions;
using System.Runtime.Loader;
using Microsoft.CodeAnalysis;
using SharpCommerce.Core.Entity;
using SharpCommerce.Core.Contracts.Entity;
using SharpCommerce.Core.Services;
...
namespace SharpCommerce
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var mvcBuilder = services.AddMvc().AddRazorOptions(o =>
            {
